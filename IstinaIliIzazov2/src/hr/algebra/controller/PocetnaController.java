...
public class PocetnaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //////PIŠE I ČITA
        trenutnaIgra.setNadimakDrugogIgraca(PROPERTIES.getProperty(NAME));
        trenutnaIgra.setTypeOfRequest("setNadimakDrugogIgraca");
    ...
    private void pokreniIgru() throws IOException {
        ...
        Repository.getTrenutnaIgra().setNadimakDrugogIgraca(nickName);
