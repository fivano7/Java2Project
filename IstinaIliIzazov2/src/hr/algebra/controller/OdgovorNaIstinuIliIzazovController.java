...
public class OdgovorNaIstinuIliIzazovController implements Initializable {
    ...
    private void postaviTekstove(boolean odabranaIstina) {
        ...
        if (odabranaIstina) {
        lblTkoKome.setText(nickNameDrugogIgraca + ", postavio si pitanje za " + nickNamePrvogIgraca + " koje je glasilo:");
        } else {
        lblTkoKome.setText(nickNameDrugogIgraca + ", izazvao si " + nickNamePrvogIgraca + " izazovom koji je glasio:");
        }
