...
import static hr.algebra.controller.PocetnaController.NAME;
import static hr.algebra.controller.PocetnaController.PROPERTIES;
...
public class OdabirKategorijeController implements Initializable {
    ...
    private void odabirKategorije(ActionEvent event) throws IOException {
        ...
        if (odabraniGumb == btnIstina) {
            ...
            trenutnaIgra.setTypeOfRequest("setOdabranaIstina");
            executeChange("OdabirKategorijeController 1");
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/hr/algebra/view/EkranCekanja.fxml"));
        Stage mainStage = IstinaIliIzazovApplication.getMainStage();
